module AskJared
  AnswerPlan = Struct.new(:architecture, :version, :intent, :target, :breadth, :answer_shape,
                          ...
                          :evidence_requirements, :scope_rules, :fallback_behavior,
                          :intent_candidates, :planning_required, :planning_reasons, :question_parts,
                          :confidence, :resolution_mode, keyword_init: true) do
    def summary
      { "intent" => intent, "target" => target, "breadth" => breadth, "answer_shape" => answer_shape,
        ...
        "intent_candidates" => intent_candidates, "planning_required" => planning_required,
        "planning_reasons" => planning_reasons, "question_parts" => question_parts,
        "confidence" => confidence, "resolution_mode" => resolution_mode }
    end
  end
end
