...
module AskJared
  class CandidateKnowledgeInventory
    ...
    def new_recruiter_evidence_records
      [
        recruiter_record("fact:engineering-profile", "Engineering profile",
          "Jared is a product-oriented full-stack software engineer with a strong Rails and backend foundation. His differentiator is translating messy user, stakeholder, and operational problems into practical software across product decisions, implementation, production operation, and iteration. He has worked with unusual breadth and autonomy in a small-company environment, while depth varies by technology and sustained large engineering-organization experience is not established.",
          "Product-oriented full-stack engineer with a strong Rails/backend foundation, broad ownership, and product judgment.",
          { "relationship" => "Professional engineering identity", "competencies" => "full_stack_engineering, rails, backend_engineering, product_judgment, technical_ownership, ambiguity, production_reliability", "claims" => [ { "text" => "Jared is a product-oriented full-stack software engineer with a strong Rails and backend foundation.", "kind" => "demonstrated", "role" => "profile" }, { "text" => "Jared translates messy user, stakeholder, and operational problems into practical software across product decisions, implementation, production operation, and iteration.", "kind" => "demonstrated", "role" => "profile" } ], "limitations" => "This is a synthesis of the approved engineering record, not a claim of equal depth in every technology or large-organization experience.", "safe_attribution" => "Use this as a concise profile synthesis and support it with distinct examples; do not reduce it to a technology inventory." }, "Jared-confirmed-2026-09-09"),
        recruiter_record("fact:engineering-scope-and-trajectory", "Engineering scope and trajectory",
          "Jared's engineering trajectory began with a strong Rails/backend focus and expanded into frontend work, product surfaces, integrations, data, deployment, testing, and production support. His end-to-end ownership means responsibility across the stages of a defined feature, workflow, integration, subsystem, or product area; it does not mean sole ownership of every aspect of Dogly or identical depth across the stack.",
          "Rails/backend depth expanded into defined-scope full-stack and product ownership.",
          { "relationship" => "Engineering scope and full-stack trajectory", "competencies" => "rails, backend_engineering, full_stack_engineering, frontend_engineering, integration, deployment, testing, production_reliability, technical_ownership", "claims" => [ { "text" => "Jared's Rails/backend foundation expanded into frontend work, product surfaces, integrations, data, deployment, testing, and production support.", "kind" => "demonstrated", "role" => "trajectory" }, { "text" => "Jared's end-to-end ownership applies to the defined scope of a feature, workflow, integration, subsystem, or product area.", "kind" => "demonstrated", "role" => "scope" } ], "limitations" => "Do not infer equal depth across technologies or sole ownership of every aspect of Dogly.", "safe_attribution" => "Use precise feature or project scope when describing ownership." }, "Jared-confirmed-2026-09-09"),
